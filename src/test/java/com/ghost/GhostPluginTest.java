...
import com.ghost.plugins.tutorialisland.TutorialIslandPlugin;
...
public class GhostPluginTest {
    ...
    {
        ExternalPluginManager.loadBuiltin(FuckenToaPlugin.class, MiningPlugin.class, GemCrabPlugin.class, WoodcuttingPlugin.class, TutorialIslandPlugin.class);
        RuneLite.main(args);
    }
}
